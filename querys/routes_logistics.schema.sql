...
CREATE TABLE routes_logistics.route ( 
  route_number INT PRIMARY KEY, --No es serial, se define manual su id
...
CREATE TABLE routes_logistics.route_contact_point (
...
CREATE TABLE routes_logistics.warehouse (
